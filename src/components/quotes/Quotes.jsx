        ...
        <div className='quotes-wrapper '>
            <div className="quotes-container flex flex-col  ">
                <div className="quotes-message flex flex-col gap-5">
                    <div className="quote">
                        <blockquote class="text-sm md:text-xl italic font-semibold text-gray-900 dark:text-white">
                    ...
                    <div className="flex justify-between">
                        <button onClick={handleClick}
                            className='bg-cyan-900 w-[120px] p-2 lg:px-4 text-white text-xs shadow-md rounded-md '
                        >
                            Generate quote
                        </button>
